      ...
      <div class="row">         
        ...
        <div id="content" class="col-md-12 full-page login">
          ...
          <div class="welcome">
            ...
            <form id="form-signin" method = "POST" action = "{{ route('register') }}" class="form-signin">
              {{ csrf_field() }}
              ...
              <section>
                ...
                <section class="new-acc">
                  <button type="submit" class="btn btn-greensea">   Register </button>
                </section> 
